...
public class MultiplyCalculationBuilder extends BaseCalculationBuilder implements ICalulcationBuilder {
    private static final String TAG = "CalcTrainer.Mulitply";


    private int number1;
    private int number2;

    public MultiplyCalculationBuilder(SharedPreferences preferences) {
        super(preferences);
    }
